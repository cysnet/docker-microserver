...
namespace MicroService
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, IApplicationLifetime applicationLifetime)
        {
            ...
            string ip = Environment.GetEnvironmentVariable("microip");
            int port = Convert.ToInt32(Configuration["microport"]);
            app.UseMvc();
        ...
        {
            var consulurl = Environment.GetEnvironmentVariable("consulurl");
            c.Address = new Uri($"http://{consulurl}:8500");
            c.Datacenter = "dc1";
